...
export function activateMockDebug(context: vscode.ExtensionContext,runMode:string) {



	// register a configuration provider for 'luat' debug type
	const provider = new MockConfigurationProvider();
	context.subscriptions.push(vscode.debug.registerDebugConfigurationProvider('luat', provider));
	...
	context.subscriptions.push(vscode.debug.registerDebugAdapterDescriptorFactory('luat', factory));
...
export function deactivateMockDebug() {
	// nothing to do
}
